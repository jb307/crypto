...
public class BuyBtcHandler implements BaseHandler {
    ...
    public HttpResponseBuilder handleRequest(ParsedRequest request) {
        ...
        try {
            ...
            Double btcAmountToBuy = requestData.get("btcAmount");
            Double btcPrice = requestData.get("btcPrice");

            if (btcAmountToBuy <= 0 || btcPrice <= 0) {
                // Handle invalid BTC amount or price
                RestApiAppResponse<TransactionDto> response = new RestApiAppResponse<>(false, null, "Invalid BTC amount or price to buy");
            ...
            double totalCost = btcAmountToBuy * btcPrice;
            ...
            buyTransaction.setCryptoType("BTC");  // Assuming BTC is being bought
            buyTransaction.setCryptoPrice(btcPrice);
            ...
            user.setBTC(user.getBTC() + btcAmountToBuy);
            ...
            RestApiAppResponse<TransactionDto> response = new RestApiAppResponse<>(true, null, "BTC purchase successful");
