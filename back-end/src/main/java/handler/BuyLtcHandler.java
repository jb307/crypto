...
public class BuyLtcHandler implements BaseHandler {
    ...
    public HttpResponseBuilder handleRequest(ParsedRequest request) {
        ...
        try {
            ...
            Double ltcAmountToBuy = requestData.get("ltcAmount");
            Double ltcPrice = requestData.get("ltcPrice");

            if (ltcAmountToBuy <= 0 || ltcPrice <= 0) {
                // Handle invalid BTC amount or price
                RestApiAppResponse<TransactionDto> response = new RestApiAppResponse<>(false, null, "Invalid LTC amount or price to buy");
            ...
            double totalCost = ltcAmountToBuy * ltcPrice;
            ...
            buyTransaction.setCryptoType("LTC");  // Assuming BTC is being bought
            buyTransaction.setCryptoPrice(ltcPrice);
            ...
            user.setLTC(user.getLTC() + ltcAmountToBuy);
            ...
            RestApiAppResponse<TransactionDto> response = new RestApiAppResponse<>(true, null, "LTC purchase successful");
